...
// Both locales, not just German (issue #89): with `t` pinned to messages.de the
// component's English strings were never rendered by any assertion here. Running
// the whole suite once per locale gives every string the same real rendering
// assertion in both languages.
