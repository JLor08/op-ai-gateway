...
for (const locale of ['de', 'en'] as readonly Locale[]) {
  ...
  describe(`AgentTokenSection copy button [${locale}]`, () => {
  ...
  describe(`AgentTokenSection agent-presence-timeout field [${locale}]`, () => {
  ...
  describe(`AgentTokenSection agent-binary downloads [${locale}]`, () => {
