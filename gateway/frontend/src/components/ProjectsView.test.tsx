...
for (const locale of ['de', 'en'] as readonly Locale[]) {
  ...
  describe(`ProjectsView list [${locale}]`, () => {
  ...
  describe(`ProjectsView create project [${locale}]`, () => {
  ...
  describe(`ProjectsView coupled projects [${locale}]`, () => {
  ...
  describe(`ProjectsView non-owner row actions [${locale}]`, () => {
    it('a plain member (can_manage false) sees no rename/members/tokens/delete row actions', async () => {
      ...
      expect(
        screen.queryByRole('button', { name: t.projectsActionRename }),
      ).not.toBeInTheDocument();
      expect(
        screen.queryByRole('button', { name: t.projectsActionMembers }),
      ).not.toBeInTheDocument();
      expect(
        screen.queryByRole('button', { name: t.projectsActionTokens }),
      ).not.toBeInTheDocument();
      expect(
        screen.queryByRole('button', { name: t.projectsActionDelete }),
      ).not.toBeInTheDocument();
    });
  ...
  describe(`ProjectsView members sub-view row actions [${locale}]`, () => {
  ...
  describe(`ProjectsView members vs. tokens sub-view split [${locale}]`, () => {
  ...
  describe(`ProjectsView tokens sub-view assigned tokens [${locale}]`, () => {
