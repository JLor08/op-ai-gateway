...
for (const locale of ['de', 'en'] as readonly Locale[]) {
  ...
  describe(`ModelList loaded column [${locale}]`, () => {
  ...
  describe(`ModelList vision column [${locale}]`, () => {
  ...
  describe(`ModelList offered column [${locale}]`, () => {
  ...
  describe(`ModelList loading column [${locale}]`, () => {
  ...
  describe(`ModelList details sub-view [${locale}]`, () => {
  ...
  describe(`ModelList visibility [${locale}]`, () => {
