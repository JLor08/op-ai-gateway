...
for (const locale of ['de', 'en'] as readonly Locale[]) {
  ...
  describe(`TokenList model override map + catch-all + log communication [${locale}]`, () => {
  ...
  describe(`TokenList project picker (spec: 2026-08-08-projects-design.md §6) [${locale}]`, () => {
  ...
  describe(`TokenList synthetic ChatSession row [${locale}]`, () => {
  ...
  describe(`TokenList one-time-secret reveal modal [${locale}]`, () => {
  ...
  describe(`TokenList rotate action [${locale}]`, () => {
  ...
  describe(`TokenList server override (Task 6) [${locale}]`, () => {
  ...
  describe(`TokenList unknown-model redirect (Task 8) [${locale}]`, () => {
  ...
  describe(`TokenList last-used-model column (Task 9) [${locale}]`, () => {
