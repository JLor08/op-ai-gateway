...
const (
	programName     = "OP AI Gateway"
	copyrightYear   = "2026"
	copyrightAuthor = "OnPrem AI Gateway contributors"
	sourceURL       = "https://github.com/JLor08/op-ai-gateway"
)

// licenseNotice returns the AGPL "Appropriate Legal Notices" for the gateway:
// the standard copyright notice (rendered by the AGPL-3.0-licensed
// github.com/donyori/gogo), the license identifier, and the source offer
// required by AGPL section 13. Printed by the `-license` subcommand.
