...
var portalMappingErrRows = []errRow{
	...
	{err: portal.ErrMappingCapabilityReserved, status: http.StatusBadRequest, code: "mapping.capability_reserved", msg: `capability_verdicts must not state "no" for "live_progress" nor any verdict for "speculation_observed"; an empty verdict still resets either`},
