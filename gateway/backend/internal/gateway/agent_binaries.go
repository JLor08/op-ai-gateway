...
// config loader strips whole-line // comments before parsing. Keep the keys/defaults
// in sync with the server-agent fixture (until Task 4 consumes the trust keys)
// AND the frontend's buildServerAgentConfig (AgentTokenSection.tsx).
